        ...
        <div class="border-t border-gray-200">
          <div class="p-4">
            <div v-if="upcomingAppointments?.length" class="space-y-4">
              <div v-for="appointment in upcomingAppointments" :key="appointment.id" class="border border-gray-200 rounded-lg p-4">
                <div class="flex justify-between items-start">
                  <div>
                    <h4 class="text-sm font-medium text-gray-900">{{ appointment.client_name }}</h4>
                    <p class="text-sm text-gray-500">{{ formatDate(appointment.scheduled_at) }}</p>
                    <div class="mt-2">
